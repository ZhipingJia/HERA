...
class CausalCollator:
    ...
    def __call__(self, features):
        # print('CausalCollator Config:')
        # print('source_max_len:')
        # print(self.source_max_len)
        # print('train_on_source:')
        # print(self.train_on_source)
        # print('input_field:')
        ...
        # print('predict_with_generate:')
        # print(self.predict_with_generate)
        # print(len(features))
        # print('features:')
        # print(features)
...
def prepare_eval_dataset(
    ...
    datasets = get_datasets_to_use(dataset_names, "validation")
